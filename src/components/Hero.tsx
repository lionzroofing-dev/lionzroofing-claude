  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-lionzGold leading-tight mb-6">
          <span className="block text-white text-base sm:text-xl md:text-2xl font-bold mb-3 opacity-80 tracking-wide">
